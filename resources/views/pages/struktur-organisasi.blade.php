...
@section('title', 'Halaman Organisasi')

@section('body')
    <div class="bg-white font-inter pt-10">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <h2 class="text-3xl font-bold tracking-tight text-blue-800">SOTK</h2>
            <p class="text-sm md:text-base">Struktur Organisasi Tenaga Kerja Desa Mekar Sari.</p>
                ...
                <div class="group relative">
                    ...
                    <div class="mt-4 flex justify-center text-center">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Kepala Desa</p>
                        </div>
                    </div>
                </div>
                <div class="group relative">
