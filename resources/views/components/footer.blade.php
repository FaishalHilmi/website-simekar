<footer class="bg-gray-100 font-inter">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="flex flex-row gap-8 sm:gap-20">
                <div>
                    ...
                    <ul class="text-blue-800 text-sm">
                        ...
                        <li class="mb-4">
                            <a href="#" class="hover:underline hover:text-blue-600">Profil Desa</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline hover:text-blue-600">Infografis</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline hover:text-blue-600">Berita</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/"
                    class="hover:underline">Mekar Sari</a>. All Rights Reserved.
            </span>
